...
create_file_response = httpx.post(
    # POST запрос на эндпоинт загрузки файла
    "http://localhost:8000/api/v1/files",
    # Как хотим назвать файл и в какую директорию он будет загружен
    data={"filename": "image.png", "directory": "courses"},
    # непосредственно откуда берем наш файл с ПК (обязательно 'rb')
    files={"upload_file": open('./testdata/files/image.png', 'rb')},
    # заголовок на авторизацию (т.к эндпоинт работает только с авторизованным пользователем)
